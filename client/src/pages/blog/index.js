...
export default function Blog() {
  ...
  const populateBlogList = () => {
    const getData = async () => {
      const response = await ApiClient.call(ApiClient.REQUEST_METHOD.POST, '/blog/getAllActiveBlog', {}, {}, {Cookie: ApiClient.cookie, Authorization: ApiClient.authorization}, false);
