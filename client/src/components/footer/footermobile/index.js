...
import {
    Typography,
    Box, TextField, Button, NativeSelect
    ...
    return (
        <div>
            <BottomNavigation showLabels value={value} onChange={handleChange} className={classes.footermenu} >
                ...
                <BottomNavigationAction label="Visit" value="Visit" icon={<Visit />} onClick={handleClickOpen} className={classes.TextbottomMenuColor} />
