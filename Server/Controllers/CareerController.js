...
module.exports = function (conn) {
    ...
    // router.post('/applyForJob', requestAuthMiddleware, careerFunction.applyForJob(db));
    // router.post('/JobApplications', userAuthMiddleware, careerFunction.JobApplications(db));
