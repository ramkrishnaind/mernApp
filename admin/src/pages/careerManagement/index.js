  ...
  function onDeleteClick(data) {
    ...
    confirmAlert({
      ...
      buttons: [
        {
          label: 'Yes',
          onClick: () => dispatch(CareerAction.CareerDeleteRequestAsync(tempdata))
        },
        {
          label: 'No',
    ...
    return (
        ...
        {career.list && career.list.length > 0 ? (
          ...
          <MUIDataTable className="table-header"
            ...
            columns={['SR No.','Degination','Department','Desctiption','Experiance','Location','Vacancy',
            {
              name: "Status",
              options: {
            ...
            },
            {
              ...
              options: {
                customBodyRender: (value, tableMeta, updateValue) => {
                  return (
                    <>
                    <EditIcon style={{ color: "#0069d9", cursor:"pointer" }} onClick={() => updatehandleOpenCreateModal(tableMeta.rowData[8])}/>

                    {tableMeta.rowData[7] ? (
                      <Tooltip title="Active">
                        <Done
                        onClick={() =>onDisable(tableMeta.rowData[8],false)}
                      ...
                      <Tooltip title="Inactive">
                        <ClearIcon 
                          onClick={() => onDisable(tableMeta.rowData[8],true)}
