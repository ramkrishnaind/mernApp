...
const RoleList = (props) => {
  ...
  return (
    <>
      <FormHeader heading1={"Role Module Management"} heading2={"List and Manage Role Here"} />
              ...
              },
              {
                ...
                options: {
                  customBodyRender: (value, tableMeta, updateValue) => {
                    return (
                      <>
                        <EditIcon style={{ color: "#0069d9", cursor: "pointer" }} onClick={() => updatehandleOpenCreateModal(tableMeta.rowData[3])} />
