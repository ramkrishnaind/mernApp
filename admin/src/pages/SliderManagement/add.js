...
const MenuCreateUpdate = (props) => {
  ...
  return (
    <Box className="MenuManagement_Data">
      ...
      {state.id ? (
        <>
          <BreadCrumbs heading1={"SliderManagement"} heading2={"Edit 1 Module"} />
          <SubHeading heading={"Edit 2 Module"} />
        </>
      ) : (
          <>
            <BreadCrumbs heading1={"SliderManagement"} heading2={"Add Slider Module"} />
            ...
            <ValidatorForm onSubmit={handleSubmit}>
              ...
              <Grid container spacing={3} className="FormFildes">
                <Grid className="form-group-item" item xs={12} sm={6} md={6}>
                  ...
                  <img src={file} height="300px" width="800px" />
                  <Box>
                    <br />
