...
export const SliderListService = async (dispatch, data) => {
    try {
        const result = await ApiClient.call(ApiClient.REQUEST_METHOD.POST, API_ENDPOINTS.SLIDER_LIST_ENDPOINT, data, null, null, true);
...
export const SliderAddService = async (dispatch, data) => {
    try {
        const result = await ApiClient.call(ApiClient.REQUEST_METHOD.POST, API_ENDPOINTS.SLIDER_ADD_ENDPOINT, data, null, null, true);
...
export const SliderStatusUpdateService = async (dispatch, data) => {
    ...
    try {
        const result = await ApiClient.call(ApiClient.REQUEST_METHOD.POST, API_ENDPOINTS.SLIDER_STATUS_UPDATE_ENDPOINT, data, null, null, true);
...
export const SliderUpdateService = async (dispatch, data) => {
    ...
    try {
        const result = await ApiClient.call(ApiClient.REQUEST_METHOD.POST, API_ENDPOINTS.SLIDER_UPDATE_ENDPOINT, data, null, null, true);
...
export const SliderDeleteService = async (dispatch, data) => {
    ...
    try {
        const result = await ApiClient.call(ApiClient.REQUEST_METHOD.POST, API_ENDPOINTS.SLIDER_DELETE_ENDPOINT, data, null, null, true);
...
export const SliderDataService = async (dispatch, data) => {
    ...
    try {
        const result = await ApiClient.call(ApiClient.REQUEST_METHOD.POST, API_ENDPOINTS.SLIDER_DATA_ENDPOINT, data, null, null, true);
